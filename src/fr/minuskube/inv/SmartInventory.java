...
public class SmartInventory {
    ...
    public Inventory open(Player player, int page) {
        ...
        InventoryOpener opener = this.manager.findOpener(this.type).orElseThrow(() -> {
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            if (this.provider == null) {
                ...
                InventoryManager manager = this.manager != null ? this.manager : GuesstheBuild.getInstance().getInventoryManager();
                if (manager == null) {
